...
import CertificatePreview, {
  CertificateFormData as PreviewFormData,
} from "../components/Certificates/CertificatePreview";

/* ============================================================
   Tipos
   ============================================================ */
type CertificateFormData = PreviewFormData;
...
// dias entre duas datas (inclusivo): 12/10 a 16/10 => 5
...
/* ============================================================
   Busca assíncrona (pacientes / profissionais)
   ============================================================ */
...
/* ============================================================
   UI controls (onValue — sem eventos)
   ============================================================ */
...
const Field = ({ label, className, value, onValue, ...rest }: FieldProps) => (
...
const TextArea = ({ label, className, value, onValue, ...rest }: TextAreaProps) => (
  <label className="block">
    <span className="block text-sm font-semibold text-gray-700 mb-2">{label}</span>
    <textarea
      {...rest}
...
export default function CertificateNew({ onBack, onCreated, initialData }: Props) {
  ...
  const [form, setForm] = useState<CertificateFormData>(() => ({
    ...
    certificateType: (initialData?.certificateType as CertificateFormData["certificateType"]) || "saude",
    reason: initialData?.reason || "Consulta médica",
    startDate: initialData?.startDate || todayISO,
    endDate: initialData?.endDate || todayISO,
    daysOfAbsence: initialData?.daysOfAbsence ?? 1,
    observations: initialData?.observations || "",
    issueDate: initialData?.issueDate || todayISO,
  ...
  // Mapeamento -> DB
  const CERT_TYPES_LABEL_DB: Record<CertificateFormData["certificateType"], string> = {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const payload: any = {
        ...
        issued_at: form.issueDate ? new Date(form.issueDate + "T12:00:00").toISOString() : new Date().toISOString(),
      ...
      <div className="sticky top-0 z-10 flex items-center gap-3 p-3 border-b bg-white/80 backdrop-blur">
        ...
        <div className="ml-auto hidden sm:flex items-center gap-2 no-print">
          ...
          <button
            onClick={handleSave}
            disabled={saving}
            className="inline-flex items-center gap-2 px-3 py-2 rounded-xl border shadow-sm disabled:opacity-60"
          >
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-sm border p-6">
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  {(
                    ["saude", "comparecimento", "afastamento", "aptidao", "incapacidade"] as CertificateFormData["certificateType"][]
                  ).map((key) => (
                    <label
                      key={key}
                    ...
                    >
                      <input
                        ...
                        onChange={(e) =>
                          setForm((prev) => ({
                            ...prev,
                            certificateType: e.target.value as CertificateFormData["certificateType"],
                          }))
                        }
                        className="mt-1"
                      />
              ...
              <div className="bg-white rounded-lg shadow-sm border p-6">
                ...
                <div className="space-y-4">
                  ...
                  <TextArea
                    ...
                    rows={3}
                    value={form.reason}
                    onValue={(val) => setForm((prev) => ({ ...prev, reason: val }))}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <Field
                      ...
                      onValue={(val) =>
                        setForm((prev) => ({
                          ...prev,
                          daysOfAbsence: Math.max(1, parseInt(val || "1", 10)),
                        }))
                      }
                    />
                  </div>
                  ...
                  <Field
                    ...
                    onValue={(val) => setForm((prev) => ({ ...prev, restrictedActivities: val }))}
                  ...
                  <div className="flex items-center gap-6">
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        onChange={(e) =>
                          setForm((prev) => ({ ...prev, requiresRest: e.target.checked }))
                        }
                      />
                    ...
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        checked={!!form.isPaid}
                        onChange={(e) =>
                          setForm((prev) => ({ ...prev, isPaid: e.target.checked }))
                        }
                      />
                  ...
                  <TextArea
                    ...
                    onValue={(val) => setForm((prev) => ({ ...prev, observations: val }))}
                  ...
                  <Field
                    ...
                    onValue={(val) => setForm((prev) => ({ ...prev, issueDate: val }))}
                  />
                </div>
              </div>
            </div>
